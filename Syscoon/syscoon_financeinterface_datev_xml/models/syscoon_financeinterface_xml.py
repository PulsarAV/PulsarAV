...
class SyscoonFinanceinterfaceXML(models.TransientModel):
    ...
    def get_total_amount(self, move_id, invoice_mode):
        ...
        for line in tax_lines:
            ...
            result[line.tax_line_id.tax_group_id]["amount"] += line.price_subtotal
        ...
        vals["tax_line"] = self._prepare_tax_line_values(move_id, invoice_mode,
                                                         currency_rate, result)
    ...
    def _prepare_tax_line_values(self, move_id, invoice_mode, currency_rate,
                                 result_values):
        value_list = []
